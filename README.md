...
Home: https://pypi.org/project/jupyterlab-server

Package license: BSD-3-Clause

Summary: A set of server components for JupyterLab and JupyterLab like applications.

Development: https://github.com/jupyterlab/jupyterlab_server
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/jupyterlab_server-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/jupyterlab_server-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add jupyterlab_server jupyterlab_server-with-openapi
# for installing globally
pixi global install jupyterlab_server jupyterlab_server-with-openapi
```
...
It is possible to list all of the versions of `jupyterlab_server` available on your platform:
...
```
pixi search jupyterlab_server --channel conda-forge
```
